...
public class DuckEntity extends TamableAnimal {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(SnookcraftModEntities.DUCK.get(), 20, 4, 4));
	}

	public DuckEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SnookcraftModEntities.DUCK.get(), world);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		DuckEntity retval = SnookcraftModEntities.DUCK.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(SnookcraftModEntities.DUCK.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
