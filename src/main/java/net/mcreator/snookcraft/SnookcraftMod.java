 ...
 *
 */
package net.mcreator.snookcraft;
...
@Mod("snookcraft")
public class SnookcraftMod {
	public static final Logger LOGGER = LogManager.getLogger(SnookcraftMod.class);
	public static final String MODID = "snookcraft";
	...
	public SnookcraftMod() {
		...
		SnookcraftModFluids.REGISTRY.register(bus);
		SnookcraftModEnchantments.REGISTRY.register(bus);
